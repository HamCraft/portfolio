...
const Contact = () => {
  return (
    <section
      id="contact"
      className="overflow-x-hidden py-16 sm:py-24 lg:py-32 text-white max-w-[1200px] mx-auto px-6 sm:px-6"
    >
      <motion.div
      ...
      >
        <div className="space-y-12">
          ...
          <motion.div
            ...
            className="glass p-6 sm:p-8 rounded-2xl space-y-6 sm:space-y-8 w-full max-w-full sm:max-w-md md:max-w-lg mx-auto sm:mx-0"
          >

...
export const Navbar = () => {
    ...
    return (
        <div className='z-50 fixed flex justify-center w-full text-white font-bold'>
            ...
            <div className="border border-white/20 mt-8 backdrop-blur-3xl rounded-2xl hidden
                ...
                <ul className='flex flex-row p-2 space-x-8'>
                    ...
                    <div onClick={toggleNav} className='md:hidden absolute top-5 right-14
                    border rounded z-50 text-white/70 border-white/70 p-2'>
